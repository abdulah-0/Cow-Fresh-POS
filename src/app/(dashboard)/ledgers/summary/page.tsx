            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <Card className="bg-white border-blue-100 shadow-sm">
                    <CardContent className="pt-6">
                        ...
                        <Link href={`/ledgers/customer`} className="mt-3 text-xs text-blue-500 flex items-center hover:underline">
                ...
                <Card className="bg-white border-red-100 shadow-sm">
                    <CardContent className="pt-6">
                        ...
                        <Link href={`/ledgers/supplier`} className="mt-3 text-xs text-red-500 flex items-center hover:underline">
