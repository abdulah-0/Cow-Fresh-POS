...
export default function SupplierLedgerPage() {
    ...
    const handleAddEntry = async () => {
        if (!selectedSupplierId || !newEntry.amount) return
        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-gray-500 mt-1">Track payables and payments to suppliers</p>
                </div>
                {selectedSupplierId && (
                                ...
                                <SelectContent>
                                    {suppliers.map(s => (
                                        <SelectItem key={s.id} value={s.id.toString()}>
                                            {s.company_name} ({s.person?.first_name} {s.person?.last_name})
                                        </SelectItem>
                                    ))}
                                </SelectContent>
                            </Select>
                        </div>
                        <Button variant="outline" onClick={loadLedger} disabled={!selectedSupplierId || loading}>
            ...
            {selectedSupplierId ? (
                        ...
                        <Card className="bg-gradient-to-br from-red-50 to-white border-red-100">
                            <CardContent className="pt-6">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <p className="text-sm font-medium text-red-600 uppercase tracking-wider">Total Credit</p>
                        ...
                        <Card className="bg-gradient-to-br from-green-50 to-white border-green-100">
                            <CardContent className="pt-6">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <p className="text-sm font-medium text-green-600 uppercase tracking-wider">Total Payments</p>
                        ...
                        <Card className="bg-gradient-to-br from-blue-600 to-indigo-700 text-white border-none shadow-lg">
                            <CardContent className="pt-6">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <p className="text-sm font-medium text-blue-100 uppercase tracking-wider">Remaining Payable</p>
                ...
                <div className="h-64 flex flex-col items-center justify-center border-2 border-dashed rounded-2xl border-gray-200 text-gray-400">
                    ...
                    <p>Please select a supplier to view their financial ledger</p>
                </div>
            )}
                    ...
                    <div className="space-y-4 py-4">
                        <div className="space-y-2">
                            ...
                            >
                                ...
                                <SelectContent>
                                    <SelectItem value="payment">Payment (Giving money)</SelectItem>
                                    <SelectItem value="credit">Credit (Stock on credit)</SelectItem>
